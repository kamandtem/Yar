...
import { ALAIN_LOVE_BOOKS } from '../../data/alainLoveBooks';
import { PageIntroAccordion } from '../common/PageIntroAccordion';

const BOOKS = [
  { data: DOPAMINE_BOOK, cover: '/images/library-books/B1.jpg', epub: null, tone: 'violet' as const },
  { data: KAIZEN_BOOK, cover: '/images/library-books/B2.jpg', epub: null, tone: 'teal' as const },
  ...ALAIN_LOVE_BOOKS.map(data => ({ data, cover: data.cover, epub: null, tone: 'teal' as const }))
];
